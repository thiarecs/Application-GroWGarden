...
class GraphSix extends StatefulWidget {
  const GraphSix({Key? key}) : super(key: key);

  @override
  State<GraphSix> createState() => _GraphSixState();
}

class _GraphSixState extends State<GraphSix> {
  ...
  void initState() {
    ...
    final databaseReference = FirebaseDatabase.instance.ref().child('Hist6');

...
class GraphFive extends StatefulWidget {
  const GraphFive({Key? key}) : super(key: key);

  @override
  State<GraphFive> createState() => _GraphFiveState();
}

class _GraphFiveState extends State<GraphFive> {
  ...
  void initState() {
    ...
    final databaseReference = FirebaseDatabase.instance.ref().child('Hist5');

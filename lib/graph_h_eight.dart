...
class GraphEight extends StatefulWidget {
  const GraphEight({Key? key}) : super(key: key);

  @override
  State<GraphEight> createState() => _GraphEightState();
}

class _GraphEightState extends State<GraphEight> {
  ...
  void initState() {
    ...
    final databaseReference = FirebaseDatabase.instance.ref().child('Hist8');
    ...
    databaseReference.onValue.listen((event) {
      ...
      if (value != null) {
        (value as Map).forEach((key, values) {
          ...
          final waterLevel = values['moisture'] as int?;

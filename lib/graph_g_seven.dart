...
class GraphSeven extends StatefulWidget {
  const GraphSeven({Key? key}) : super(key: key);

  @override
  State<GraphSeven> createState() => _GraphSevenState();
}

class _GraphSevenState extends State<GraphSeven> {
  ...
  void initState() {
    ...
    final databaseReference = FirebaseDatabase.instance.ref().child('Hist7');

...
class GraphFour extends StatefulWidget {
  const GraphFour({Key? key}) : super(key: key);

  @override
  State<GraphFour> createState() => _GraphFourState();
}

class _GraphFourState extends State<GraphFour> {
  ...
  void initState() {
    ...
    final databaseReference = FirebaseDatabase.instance.ref().child('Hist4');

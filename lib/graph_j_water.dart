...
class GraphTen extends StatefulWidget {
  const GraphTen({Key? key}) : super(key: key);

  @override
  State<GraphTen> createState() => _GraphTenState();
}

class _GraphTenState extends State<GraphTen> {
  ...
  void initState() {
    ...
    final databaseReference =
        FirebaseDatabase.instance.ref().child('WaterHist');
    ...
    databaseReference.onValue.listen((event) {
      ...
      if (value != null) {
        (value as Map).forEach((key, values) {
          ...
          final waterLevel = values['Water-level'] as int?;
